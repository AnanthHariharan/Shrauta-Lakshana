"""
Type-Token Frequency Analysis for Vedic Sanskrit Diachronic Studies

This module implements comprehensive type-token analysis alongside traditional token frequency:

Type Analysis: Counts unique forms (vocabulary richness, morphological diversity)
Token Analysis: Counts total occurrences (frequency, productivity)
...
class VedicTypeTokenAnalyzer:
    ...
    def _extract_stem(self, word_form):
        \"\"\"Simple stemming for morphological analysis\"\"\"
        # Remove common Vedic suffixes for stem extraction
        suffixes = [
    ...
    def calculate_morphological_productivity(self):
        \"\"\"Calculate morphological productivity metrics\"\"\"
    ...
    def _estimate_potential_vocabulary(self, text_name, feature_name):
        \"\"\"Estimate potential vocabulary size using frequency distribution\"\"\"
    ...
    def analyze_frequency_distributions(self):
        \"\"\"Analyze frequency distributions and Zipfian patterns\"\"\"
    ...
    def compare_type_token_evolution(self, texts_ordered):
        \"\"\"Compare type-token evolution across chronologically ordered texts\"\"\"
    ...
    def generate_comprehensive_report(self, output_file='type_token_analysis_report.txt'):
        \"\"\"Generate comprehensive type-token analysis report\"\"\"
...
class VedicTypeTokenVisualizer:
    ...
    def plot_type_token_comparison(self, feature_subset=None):
        ...
        for idx, feature in enumerate(feature_subset[:6]):
            ...
            if tokens and types:
                # Create scatter plot
                colors = ["red"]*4 + ["blue"]*4 + ["green"]*4  # By period
